    ...
    return (
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center animate-slide-up">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-bold text-accent text-glow-accent mb-6">GAME KUBUS</h2>
          ...
          <div className="mt-6">
            <button onClick={() => navigate("/math-game-arena/kelas-8/bangun-ruang-sisi-datar")} className="text-sm text-muted-foreground hover:text-primary transition-colors cursor-pointer">← Kembali ke Bangun Ruang Sisi Datar</button>
          </div>
        </div>
      </div>
    );
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center animate-slide-up">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <button onClick={() => navigate("/math-game-arena/kelas-8/bangun-ruang-sisi-datar")} className="font-display text-sm px-6 py-2 rounded-lg bg-muted text-foreground cursor-pointer hover:opacity-90">Kembali</button>
